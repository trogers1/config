import { PolicyConfig } from "./extensions/permissions";
    ...
    default: {
      ...
      tools: {
        bash: [
          ...
          {
            pattern:
              "bash *skills/address-comments/scripts/enrich-discussions.sh*",
            decision: "allow",
          },
          {
            pattern:
              "bash *skills/address-comments/scripts/render-comments-md.sh*",
            decision: "allow",
          },
          {
            pattern:
